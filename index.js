...
app.get("https://tuf-assignment-topaz.vercel.app/user", (req,res)=>{
...
app.post("https://tuf-assignment-topaz.vercel.app/user", (req,res)=>{
    // Extract form data
    ...
    connection.query(q, [username, codeLanguage, stdin, sourceCode, timestamp], (err, result) => {
        if(err) {
            ...
            res.redirect("https://tuf-assignment-topaz.vercel.app/user"); // Redirect to the /user page to show the inserted data
        }
    });
});

//Page1
app.get("https://tuf-assignment-topaz.vercel.app/codeSubmit", (req,res)=>{
    res.render("index1.ejs");
});


app.get("https://tuf-assignment-topaz.vercel.app/", (req,res)=>{
    res.send(" Is working");
});
